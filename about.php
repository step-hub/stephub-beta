    ...
    <div class="container">
        <div class="card mt-5">
            ...
            <div class="card-body shadow-sm">
                <div class="row">
                    <div class="col-4">
                        <nav id="navbar-example3" class="navbar bg-light shadow-sm">
                            <nav class="nav nav-pills flex-column">
                                <a class="nav-link" href="#about">Про Нас</a>
                                <nav class="nav nav-pills flex-column">
                                    <a class="nav-link ml-3 my-1" href="#item-1-1">Що ми робимо?</a>
                                    <a class="nav-link ml-3 my-1" href="#item-1-2">Наша команда</a>
                                    <a class="nav-link ml-3 my-1" href="#item-1-3">Наша місія</a>
                                </nav>
                                <a class="nav-link" href="#terms">Правила користування</a>
                                <nav class="nav nav-pills flex-column">
                                    <a class="nav-link ml-3 my-1" href="#item-2-1">Терміни та визначення</a>
                                    <a class="nav-link ml-3 my-1" href="#item-2-2">Основні положення</a>
                                    <a class="nav-link ml-3 my-1" href="#item-2-3">Права та обов'язки сторін</a>
                                    <a class="nav-link ml-3 my-1" href="#item-2-4">Порядок розгляду спорів та відповідальність сорін</a>
                                    <a class="nav-link ml-3 my-1" href="#item-2-5">Персональні дані</a>
                                </nav>
                    ...
                    <div class="col-8">
                        <div data-spy="scroll" data-target="#navbar-example3" data-offset="0">
                            <h3 id="about">Про Нас</h3>
                            <h4 id="item-1-1">Що ми робимо?</h4>
                            ...
                            <h4 id="item-1-2">Наша команда</h4>
                            ...
                            <h3 id="terms" class="pt-5 mt-5">Правила користування сервісом StepHub</h3>
                            ...
                            <h4 id="item-2-1">Терміни та визначення</h4>
                            ...
                            <h4 id="item-2-2">Основні положення</h4>
                            <ol class="pl-0">
                            ...
                            <h4 id="item-2-3">Права та обов'язки сторін</h4>
                            <ol class="pl-0">
                            ...
                            <h4 id="item-2-4">Порядок розгляду спорів та відповідальність сторін</h4>
                            <ol class="pl-0">
                            ...
                            <h4 id="item-2-5">Персональні дані</h4>
                            ...
                            <h3 id="privacy" class="pt-5 mt-5">Політика конфіденційності</h3>
                            ...
                            <h4 id="item-3-1">Визначення понять</h4>
                            ...
                            <h4 id="item-3-2">Загальні положення</h4>
                            ...
                            <h4 id="item-3-3">Повідомлення</h4>
                            <ol class="pl-0">
                            ...
                            <h4 id="item-3-4">Зобов'язання</h4>
                            <ol class="pl-0">
                            ...
                            <h4 id="item-3-5">Прикінцеві положення</h4>
                            <ol class="pl-0">
                                ...
                                <li>При видаленні облікового запису Передавальної сторони, персональні дані такої сторони негайно видаляються, якщо Передавальна сторона раніше не була викрита в шахрайстві на Сайті та звернулася з відповідним проханням до Одержуючої сторони по електронній пошті.: support@stephub.com.</li>
                                <li>Щоб отримати доступ до інформації, задати питання з приводу нашої політики конфіденційності або подати скаргу, надішліть листа електронною поштою: support@stephub.com.</li>
                            </ol>
                        </div>
                    </div>
                </div>
