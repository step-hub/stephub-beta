            ...
            <div class="card shadow-sm mt-5">
                <div class="card-header">
                    <form class="form">
                        ...
                        <textarea type="text" rows="3" class="form-control mb-2 mr-sm-2" id="comment_field"
                                  placeholder="Leave Comment"></textarea>
                        <button type="submit" class="btn my-btn-blue mt-1 mb-2"><i class="fas fa-comment mr-2"></i>Comment
                        </button>
                    </form>
                </div>
                <div class="card-body bg-light">
