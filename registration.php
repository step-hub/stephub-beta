        ...
        <div class="card">
            <div class="card-body shadow-sm">
                ...
                <form class="form-login" action="registration.php" method="POST">
                    ...
                    <input type="login" id="inputLogin" name="login" value="<?= @$data['login']; ?>"
                           class="form-control bg-light" placeholder="Username" required autofocus>

                    <label for="inputEmail" class="sr-only">Email address</label>
                    <input type="email" id="inputEmail" name="email" value="<?= @$data['email']; ?>"
                           class="form-control bg-light" placeholder="Email Address" required>

                    <label for="inputStudNum" class="sr-only">Student ID</label>
                    <input type="text" id="inputStudNum" name="stud_num" value="<?= @$data['stud_num']; ?>"
                           class="form-control bg-light" placeholder="Student ID" required>

                    <label for="inputTelegram" class="sr-only">Telegram ID</label>
                    <input type="text" id="inputTelegram" name="telegram" value="<?= @$data['telegram']; ?>"
                           class="form-control bg-light" placeholder="Telegram Username" required>

                    <label for="inputPassword" class="sr-only">Password</label>
                    <input type="password" id="inputPassword" name="password" class="form-control bg-light"
                           placeholder="Password" required>

                    <label for="inputPasswordConfirm" class="sr-only">Confirm password</label>
                    <input type="password" id="inputPasswordConfirm" name="password_confirmation"
                           class="form-control bg-light" placeholder="Confirm Password" required>
