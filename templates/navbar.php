<nav id="navbar" class="navbar navbar-expand-lg fixed-top linear-gradient-gray <?php if (basename($_SERVER['PHP_SELF']) != "index.php") {
    ...
    <div class="container">
        <a class="navbar-brand<?php if (basename($_SERVER['PHP_SELF']) == "admin.php" or basename($_SERVER['PHP_SELF']) == "moderator.php") {
                                    echo "-sm my-color-dark";
                                } ?>" href="index.php">StepHub</a>
        ...
        <div class="collapse navbar-collapse <?php if (basename($_SERVER['PHP_SELF']) == "admin.php" or basename($_SERVER['PHP_SELF']) == "moderator.php") {
                                                    echo "small";
                                                } ?>" id="navbarResponsive">
