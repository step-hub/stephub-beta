...
- [Опис проєкту](#опис-проєкту)
  - [Опис](#опис)
    - [Проблема](#проблема)
    - [Ідея](#ідея)
    - [Алгоритм роботи](#алгоритм-за-яким-реалізовано-дану-ідею-наступний)
  - [Технічна частина проєкту](#технічна-частина-проєкту)
    - [Фреймворки та допоміжні засоби](#фреймворки-та-допоміжні-засоби-якими-користувалися-під-час-розробки)
    - [Основні вимоги до фронтенду та бекенду](#під-час-проєктування-сервісу-було-виділено-такі-основні-вимоги-до-фронтенду-та-бекенду)
    - [Front-end](#front-end)
    - [Back-end](#back-end)
      - [Перевірка на цензуру](#перевірка-на-цензуру-відбувається-наступним-чином)
- [Початок роботи](#початок-роботи)
  - [Підключення до БД](#підключення-до-бд)
...
Хост: [stephub.000webhostapp.com](https://stephub.000webhostapp.com/)
...
[Посилання на додаткові ресуси](https://step-hub.github.io/stephub/)
